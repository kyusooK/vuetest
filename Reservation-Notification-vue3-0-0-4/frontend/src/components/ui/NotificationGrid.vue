                ...
                <v-table>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="whitespace-nowrap" label="TaskId">{{ val.taskId }}</td>
                            <td class="whitespace-nowrap" label="DueDate">{{ val.dueDate }}</td>
        ...
        <v-col>
            ...
            >
                <v-card>
                    ...
                    <v-card-text>
                        <div>
                            <String label="NotificationId" v-model="selectedRow.notificationId" :editMode="true"/>
                            <String label="UserId" v-model="selectedRow.userId" :editMode="true"/>
                            <String label="TaskId" v-model="selectedRow.taskId" :editMode="true"/>
                            <Date label="DueDate" v-model="selectedRow.dueDate" :editMode="true"/>
