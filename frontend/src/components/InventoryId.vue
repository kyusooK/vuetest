<template>
    <div>
        ...
        <div v-else>
            <BasePicker v-if="editMode" searchApiPath="inventories" searchParameterName=""  idField="" nameField="" path="inventories" label="InventoryId" v-model="value" @selected="pick" :editMode="editMode" />
